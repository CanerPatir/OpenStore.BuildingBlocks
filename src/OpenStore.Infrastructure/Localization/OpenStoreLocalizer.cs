...
public class OpenStoreLocalizer : IOpenStoreLocalizer
{
    ...
    public OpenStoreLocalizer(IStringLocalizerFactory localizerFactory, IOptions<OpenStoreResxLocalizationOptions> openStoreLocalizationOptionsOptions)
    {
        ...
        _localizer = localizerFactory.Create(openStoreLocalizationOptions.SharedResourceName,
            openStoreLocalizationOptions.Assembly.FullName ?? throw new InvalidOperationException("openStoreLocalizationOptions.Assembly is null"));
    }
